        ...
        <div class="row " id="main-admin">
                    ...
                    <div class="col-md-6 ">
                        <a class="btn btn-primary btn-block" href="<?=base_url('personalTrainer/adicionarPlanoTreinoPasso2/').$id."/1"?>">Todos
                            ...
                            <div class="col-md-12">  
                                ...
                                <?= form_open("personalTrainer/adicionarPlanoTreinoPasso2")?>
            ...
            endforeach ?>
                ...
                <div class="plano-treino-divs">
                    ...
                    <div class="modal fade myModal" id="edit<?php echo $exercicioAssoc['id'];?>" tabindex="-1" role="dialog"
